...
public class ConcurrentCachedValueStore implements ValueStore {
     ...
     */
    public ConcurrentCachedValueStore(List<ValueStore> valueStores, CacheService<String, String> cacheService) {
     ...
     */
    public ConcurrentCachedValueStore(List<ValueStore> valueStores, int maxCachedItems) {
        this.valueStores = valueStores;
